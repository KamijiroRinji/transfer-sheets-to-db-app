...
Примечание: первый проект с React, безупречно справиться с первого раза не удалось. Бэкенд на Flask точно работает.
...
6. При оценке читаемости кода не требуется 100% соблюдения стандарта PEP 8, но код должен быть логичен и не перегружен, необходимо соблюдение отступов и логики названия переменных и структур данных.
